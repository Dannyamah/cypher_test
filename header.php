...
<!-- Mirrored from gnodesign.com/templates/movify/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Oct 2022 10:18:14 GMT -->
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="navbar-collapse" id="main-nav">
                        ...
                        <ul class="navbar-nav extra-nav">
                            <?php
                            // if the session is active(user is logged in)
                            if (isset($_SESSION['user'])) {
                            ?>

                            <li class="nav-item m-auto">
                                <h5 class="text-white"> <?php echo $_SESSION['user']['name'] ?> </h5>
                            </li>
